...
class _CalendarScreenState extends ConsumerState<CalendarScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final items = ref
        ...
        .toList();
    final selectedItems = _itemsForDay(items, _selectedDate);
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Text(
                DateFormat.yMMMMEEEEd(locale).format(_selectedDate),
          ...
          if (selectedItems.isEmpty)
            ...
            SliverList.builder(
              ...
              itemBuilder: (context, index) =>
                  MemoryItemCard(item: selectedItems[index]),
            ),
        ],
      ),
    );
  ...
  List<MemoryItem> _itemsForDay(List<MemoryItem> items, DateTime date) {
