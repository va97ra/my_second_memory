...
class CalendarDayCellSurface {
  ...
  ///
  /// Подмешивается цвет текста, а не серый: в светлой теме он затемняет
  /// бумагу, в тёмной — высветляет, и день заметен в обеих, а не только в
  /// той, под которую подбирали оттенок.
  ///
  /// Четырнадцати сотых не хватало: на светлой бумаге разница читалась только
  /// в упор. Тридцать даёт плитку, которую видно боковым зрением, и всё ещё
  /// оставляет запас контраста тексту записей поверх неё.
  static const todayShadeOpacity = 0.30;
  ...
  BoxDecoration decoration(
    ...
    return BoxDecoration(
      // Сегодня отмечено притенённой бумагой: чёрная обводка спорила с
  ...
  /// Сегодняшний день — та же бумага, притенённая цветом текста.
