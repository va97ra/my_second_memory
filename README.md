...
панель добавляет к этому быстрые инструменты: калькулятор, финансы и конвертер
величин; два места в ней оставлены свободными. В финансах есть конвертер валют
