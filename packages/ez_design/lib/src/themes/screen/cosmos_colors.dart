...
const cosmosColors = ScreenThemeColors(
  ...
  navigation: Color(0xFF11151D),
  panel: Color(0xFF1B2029),
  raised: Color(0xFF222833),
  nested: Color(0xFF2A313E),
  tile: Color(0xFF212734),
  weekday: Color(0xFF1B212B),
  border: Color(0xFF333B4A),
  divider: Color(0xFF2A313E),
