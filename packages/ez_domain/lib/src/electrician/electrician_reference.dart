...
const electricianReference = <ElectricianCard>[
  ...
  ElectricianCard(
    ...
    caution:
        'Таблицы в калькуляторе пока не сверены человеком с ПУЭ. Результат нельзя использовать для монтажа без проверки проекта, паспорта кабеля и условий трассы.',
