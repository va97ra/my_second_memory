...
/// и герц определены в словаре учебника, и второй раз то же самое здесь не
/// пишется. Тема «Единицы измерения» объясняет приставки и связи, а
/// определения ищутся в словаре.
library;

import 'electrician_learning.dart';

const learningLevel1 = <LearningTopic>[
  LearningTopic(
    id: 'learn_current',
    level: 1,
