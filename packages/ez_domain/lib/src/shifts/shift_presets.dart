...
/// На сколько дней вперёд график расставляет будильники.
///
/// Дальше загадывать нечего: система держит ограниченное число ожидающих
/// уведомлений, а расписание всё равно пересобирается при каждом запуске.
const shiftAlarmHorizonDays = 45;
