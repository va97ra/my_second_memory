...
///
/// Цифры допустимого тока подтверждены владельцем — практикующим
/// электриком — 1 сентября 2026 года. До этого дня они стояли здесь со слов
/// ассистента и были помечены как несверенные.
///
/// Чего в таблицах по-прежнему нет: столбцов для кабеля с двумя и тремя
/// жилами. ПУЭ различает одножильные провода в трубе и кабель, и значения у
/// них разные; здесь только первое. Пока столбцов нет, трёхжильный кабель
/// считается по столбцу трёх одножильных — это не он.
library;
